...
void mote::walking::HumanoidPart::dump()
{
	...
	std::cout << "-- RightHip" << std::endl;
	std::cout << "     Pitch: " << this->rightHip.angle.pitch << "(" << this->rightHip.velocity.pitch << ")" << std::endl;
	std::cout << "     Roll : " << this->rightHip.angle.roll << "(" << this->rightHip.velocity.roll << ")" << std::endl;
	std::cout << "     Elbow: " << this->rightHip.angle.yaw << "(" << this->rightHip.velocity.yaw << ")" << std::endl;
	...
	std::cout << "     Elbow: " << this->leftHip.angle.yaw << "(" << this->leftHip.velocity.yaw << ")" << std::endl;
